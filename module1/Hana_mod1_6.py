class person_details:
    ...
    def save(self):
        file=open(".\\module1\\person_details.txt", "w")
...
#I created a class type for person details and it's attributes.
#then ask the user to give input and then save/store in txt file.
